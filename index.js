...
(function () {
    ...
    function Runner(outerContainerId, opt_config) {
        ...
        this.groupToPersonsMap = new Map([
            ["SMALL1", [this.persons.RAM]],
            ["SMALL2", [this.persons.MISHA, this.persons.ANA]],
            ["SMALL3", [this.persons.SLAVA, this.persons.SERGII, this.persons.LEONID]],
            ["LARGE1", [this.persons.RAM]],
            ["LARGE2", [this.persons.MISHA, this.persons.ELHAM]],
            ["LARGE3", [this.persons.NICOLE, this.persons.MAHEESHA, this.persons.SLAVA]],
            ["PTERO", [this.persons.Q]],
        ])
    ...
    function VictoryPanel(canvas, textImgPos, restartImgPos, dimensions, isPlaying){
